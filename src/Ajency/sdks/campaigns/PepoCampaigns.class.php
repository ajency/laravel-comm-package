...
class PepoCampaigns
{
    ...
    function __construct($keys=array()){
        $this->pepo_key = '5947f2b09bd48e29dff319174c7cee2b';//config('ajency.comm.aj-comm-campaign.pepo.key'); //$keys['key'];
        $this->pepo_secret = '28406726a18f9f00c2e774441adc477b';//config('ajency.comm.aj-comm-campaign.pepo.secret'); //$keys['secret'];
